"""Caching the results of a function call given the same arguments
...
def main():
    ...
    print(
        f"Time taken for CacheFunc: {time_cache_func2:.6f} seconds, ran {cachefunc2_iterations} times"
    )
    print(
        f"Average time taken for CacheFunc: {time_cache_func2/cachefunc2_iterations:.6f} seconds"
    )
